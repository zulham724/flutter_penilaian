  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
          ...
          child: Text('Ke Halaman Profile ==> "Selesai"'),
          ),
          RaisedButton(onPressed: ()=>Get.to(PaketSoalView()),
          child: Text('Ke Halaman Paket Soal ==> "Selesai"'),
          ),
          RaisedButton(onPressed: ()=>Get.to(ButirSoalView()),
          child: Text('Ke Halaman Butir Soal ==> "Selesai"'),
          ),
          ...
          child: Text('Ke Halaman Penilaian Akhir ==> "Selesai"'),
          ),
          ...
          child: Text('Ke Halaman Soal Terkait ==> "Selesai"'),
          ),
          RaisedButton(onPressed: ()=>Get.to(SoalTerkaitErrorView()),
          child: Text('Ke Halaman Soal Terkait (Error) ==> "Selesai"'),
          ),
          RaisedButton(onPressed: ()=>Get.to(BagikanView()),
          child: Text('Ke Halaman Bagikan ==> "Selesai"'),
          ),
          ...
          child: Text('Ke Halaman Profil 2 ==> "Selesai'),
          ),
          ...
          child: Text('Ke Halaman Statistik Dan Ranking 2 ==> "Selesai"'),
          ),
          RaisedButton(onPressed: ()=>Get.to(SuntingPengaturanView()),
          child: Text('Ke Halaman Sunting Pengaturan Soal ==> "Selesai"'),
          ),
        ],
      )),
    );
