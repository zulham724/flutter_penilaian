  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
          ...
          child: Text('Ke Halaman Hasil'),
          ),
          RaisedButton(onPressed: ()=>Get.to(NilaiView()),
          child: Text('Ke Halaman Nilai'),
          ),
          ...
          child: Text('Ke Halaman Buat Soal (Isi)'),
          ),
          ...
          child: Text('Ke Halaman Buat Soal (Selesai)'),
          ),
          RaisedButton(onPressed: ()=>Get.to(RakitSoalIsiView()),
          child: Text('Ke Halaman Rakit Soal (Isi)'),
          ),
          RaisedButton(onPressed: ()=>Get.to(RakitSoalBuatView()),
          child: Text('Ke Halaman Rakit Soal (Buat)'),
          ),
          ...
          child: Text('Ke Halaman Preview Paket Soal 1'),
          ),
          RaisedButton(onPressed: ()=>Get.to(PreviewPaketSoal2View()),
          child: Text('Ke Halaman Preview Paket Soal 2'),
          ),
          RaisedButton(onPressed: ()=>Get.to(PreviewPaketSoal3View()),
          child: Text('Ke Halaman Preview Paket Soal 3'),
          ),
          RaisedButton(onPressed: ()=>Get.to(RakitSoalSelesaiView()),
          child: Text('Ke Halaman Rakit Soal (Selesai)'),
          ),
          RaisedButton(onPressed: ()=>Get.to(Bagikan2View()),
          child: Text('Ke Halaman Bagikan 2'),
          ),
          ...
          child: Text('Ke Halaman Ranking 2'),
          ),
          RaisedButton(onPressed: ()=>Get.to(Statistik1View()),
          child: Text('Ke Halaman Statistik 1'),
          ),
          RaisedButton(onPressed: ()=>Get.to(Statistik2View()),
          child: Text('Ke Halaman Statistik 2'),
          ),
